    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function init() {
                ...
                var punto = <?= '{"type":"Feature","properties":{},"geometry":{"type":"Point","coordinates":['.$latitud.','.$longitud.']},"crs":{"type":"name","properties":{"name":"urn:ogc:def:crs:OGC:1.3:CRS84"}}}' ?>;
                var upms = new OpenLayers.Layer.Vector("Cotizacion", {
                ...
                map.addLayer(upms);
                var f = addFeature(punto, map.baseLayer.projection, upms);
                var b = bounds(f, b);
                map.zoomToExtent(b);
