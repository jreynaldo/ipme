<script type="text/javascript">
    ...
    function unselect() {
        $('input:checkbox[name ^= com]').prop('checked', false);
    }
    function asignar(button) {
        ...
        if (cot === undefined) {
            ...
            var upms = '{';
            $('input:checkbox[name ^= com]:checked').each(function(i, val){
                upms = upms + $(val).val() + ',';
            });
            if (upms.length > 1) {
            ...
            if (upms === '{}') {
                ...
                $.post('guardar_comercializadoras', {
                    cot: cot,
                    upms: upms
                }, function (result) {
                    if (result === '') {
    ...
    function reasignar(button) {
        ...
        if (cot === undefined) {
            ...
            upms = upms + '}';
            if (upms === '{}') {
                alert('Debe seleccionar al menos una asignacion.');
                button.disabled = false;
            } else {
                $.post('guardar_comercializadoras', {
                    cot: cot,        
        ...
        <div class="row" style="padding-left: 20px; padding-right: 20px; height: 75vh;">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form method="Get" class="form-horizontal">
                                ...
                                &nbsp;<b>Mes: </b><?= $values['mes'].' <b>Año: </b>'.$values['anio'] ?>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-male fa-fw"></i>Seleccione las Comercializadoras
                        </div>
                        <div class="panel-body">
                            ...
                            <table class="table table-advance table-bordered tbl">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="com<?= $comercializadoras[$i]['carga'] ?>" class="cotManual" value="<?= $comercializadoras[$i]['id_informador'] ?>"/></td>
                                        <td><button onclick="select('<?= $comercializadoras[$i]['carga'] ?>')"><?= $comercializadoras[$i]['carga'] ?></button></td>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <i class="fa fa-list"> Asignacion Creada</i>
                            </div>
                            <div class="panel-body">
                                <table class="table table-advance table-bordered tbl">
                                    <thead>
