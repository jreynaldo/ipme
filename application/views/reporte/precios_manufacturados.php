<script type="text/javascript">
    ...
    function detallado() {
        ...
        if (cods.length > 0) {
            ...
            post('../excel/precios_manufacturados_rep_detallado', {
                perini: perini,
                perfin: perfin,
                cod: cods
            });
    ...
    function horizontal() {
        ...
        if (cods.length > 0) {
            ...
            var perini = $("#gesini").val() + '_' + ($("#mesini").val() < 10 ? '0' + $("#mesini").val() : $("#mesini").val());
            var perfin = $("#gesfin").val() + '_' + ($("#mesfin").val() < 10 ? '0' + $("#mesfin").val() : $("#mesfin").val());
            post('../excel/precios_manufacturados_rep_horizontal', {
                cod: cods,
                perini: perini,
                perfin: perfin
            });
    ...
    function horizontal_unificado() {
        ...
        if (cods.length > 0) {
            ...
            var perini = $("#gesini").val() + '_' + ($("#mesini").val() < 10 ? '0' + $("#mesini").val() : $("#mesini").val());
            var perfin = $("#gesfin").val() + '_' + ($("#mesfin").val() < 10 ? '0' + $("#mesfin").val() : $("#mesfin").val());
            post('../excel/precios_manufacturados_rep_horizontal_unificado', {
                cod: cods,
                perini: perini,
                perfin: perfin
            });
    ...
    function georeferencia() {
        ...
        if (cods.length > 0) {
            ...
            var perini = $("#gesini").val() + '_' + ($("#mesini").val() < 10 ? '0' + $("#mesini").val() : $("#mesini").val());
            var perfin = $("#gesfin").val() + '_' + ($("#mesfin").val() < 10 ? '0' + $("#mesfin").val() : $("#mesfin").val());
            post('../excel/georeferencia_manufacturados', {
                cod: cods,
                perini: perini,
                perfin: perfin
            });
                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div style="margin-bottom: 10px">
                                <button class="btn btn-primary" type="button" onclick="horizontal_unificado()">
                                    <i class="fa fa-table"></i> Reporte Unidades Unificadas
                                </button>
                            </div>
                            <div style="margin-bottom: 10px">
                                <button class="btn btn-primary" type="button" onclick="georeferencia()">
                                    <i class="fa fa-map-marker"></i> Reporte Georeferenciaci&oacute;n
                                </button>
                            </div>
                            <!--<div>
