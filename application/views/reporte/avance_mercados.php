                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <?php if ($this->input->get('anterior')): ?>
                                <a href="avance_mercados" class="btn btn-primary">Siguiente Semana</a>
                            <?php else: ?>
                                <a href="avance_mercados?anterior=1" class="btn btn-primary">Anterior Semana</a>
                            <?php endif; ?>
                            <h3><i class="icon-ok-circle"></i>Asignación semana: <?= $periodo; ?></h3>
