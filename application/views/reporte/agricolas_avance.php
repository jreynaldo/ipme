                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <?php if ($this->input->get('anterior')): ?>
                                <a href="agricolas_avance" class="btn btn-primary">Siguiente Semana</a>
                            <?php else: ?>
                                <a href="agricolas_avance?anterior=1" class="btn btn-primary">Anterior Semana</a>
                            <?php endif; ?>
                            <h3><i class="icon-ok-circle"></i>Consolidación semana: <?= $periodo; ?></h3>
