                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <?php if ($this->input->get('anterior')): ?>
                                <a href="avance_comercializadoras" class="btn btn-primary">Siguiente Mes</a>
                            <?php else: ?>
                                <a href="avance_comercializadoras?anterior=1" class="btn btn-primary">Anterior Mes</a>
                            <?php endif; ?>
                            <h3><i class="icon-ok-circle"></i>Asignación mes: <?= $periodo; ?></h3>
